...
def main(stdscr):
    ...
    #pantalla(stdscr)
    # create a game box
    sh, sw = stdscr.getmaxyx() #Size of screen y,x  ... height width 
    box = [[3,3], [sh-3, sw-3]]  # [[ul_y, ul_x], [dr_y, dr_x]]
    textpad.rectangle(stdscr, box[0][0], box[0][1], box[1][0], box[1][1])

    # create snake and set initial direction sh=80 sw=40 da [[40, 21], [40, 20], [40, 19]]
    #Crea un cuerpo de 3 posiciones x=21,20,19 con y=40 que va a la derecha
    ...
    while 1:
        ...
        if snake[0] == food:
            ...
            # shift snake's tail ,elimina cola ...
